  ...
  messages.forEach(async (message) => {
    try {
      ...
      if (firstLineBreakPosition !== -1) {
        ...
        contentRepo = content.substring(0, firstLineBreakPosition);
      } else {
        contentRepo = content;
      }
      ...
      if (
        (contentRepo.startsWith("Repo:") ||
          contentRepo.startsWith("Front - repo:") ||
          contentRepo.startsWith("Back - repo:")) &&
        contentRepo.includes("https://github.com")
      ) {
        const repoURLPosition = contentRepo.search("https://github.com");
